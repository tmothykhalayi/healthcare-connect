...
export class MedicinesController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Prescription medicines retrieved successfully',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'OTC medicines retrieved successfully',
  })
  findOTCMedicines() {
  ...
  @ApiResponse({
    status: 200,
    description: 'Medicines by user retrieved successfully',
  })
  findByUserId(
  ...
  @ApiResponse({
    status: 200,
    description: 'Medicines by price range retrieved successfully',
  })
